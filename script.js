...
const translations = {
    es: {
        ...
        "cert1_name": "SEO y content marketing",
        "cert1_desc": "Fundamentos de SEO y creación de contenido para posicionar marcas y atraer audiencia digital.",
        "cert2_name": "Marketing automation",
        "cert2_desc": "Automatización de procesos de marketing para optimizar campañas y la relación con clientes.",
        "cert3_name": "Introducción al comportamiento del consumidor",
        "cert3_desc": "Principios psicológicos y de mercado que explican las decisiones de compra de los consumidores.",
        "cert4_name": "Introducción a la Ciencia de Datos",
        "cert4_desc": "Conceptos fundamentales de ciencia de datos: recolección, análisis y visualización de información.",
        "cert5_name": "Google: IA Práctica para Marketing",
        "cert5_desc": "Aplicación práctica de inteligencia artificial generativa en estrategias de marketing.",
        "cert6_name": "Excel",
        "cert6_desc": "Manejo intermedio de Microsoft Excel para el análisis y la organización de datos.",
        "cert7_name": "English Fundamentals: Collaborating for Team Success",
        "cert7_desc": "Vocabulario y habilidades de comunicación en inglés para el trabajo colaborativo en equipo.",
        "cert8_name": "Domina la IA con Gemini",
        "cert8_desc": "Uso práctico de Gemini como asistente de inteligencia artificial para el día a día.",
        "cert9_name": "Desarrollo y Crecimiento Profesional",
        "cert9_desc": "Estrategias para la planificación de carrera y el desarrollo de habilidades profesionales.",
        "cert10_name": "Elevating Your English: Communicating as a Leader",
        "cert10_desc": "Inglés avanzado orientado a la comunicación de liderazgo en entornos profesionales.",
        "cert11_name": "Del propósito a la acción: Generando impacto en sostenibilidad",
        "cert11_desc": "Herramientas para transformar objetivos de sostenibilidad en acciones concretas.",
        "cert12_name": "AI and Responsibility: Creating a Positive AI",
        "cert12_desc": "Principios de ética e inteligencia artificial responsable según IBM.",
        "cert13_name": "Power BI Intermedio: Análisis y modelado de datos",
        "cert13_desc": "Análisis y modelado de datos con Power BI a nivel intermedio.",
        "cert14_name": "Customer centricity y experiencia de cliente",
        "cert14_desc": "Estrategia y transformación digital centrada en el cliente, orientada a líderes.",
        "cert15_name": "Gestión de Proyectos y Fundamentos de metodología Agile",
        "cert15_desc": "Fundamentos de gestión de proyectos y metodologías ágiles.",
        "cert16_name": "Product management: diseño y lanzamiento de productos digitales",
        "cert16_desc": "Proceso de diseño, desarrollo y lanzamiento de productos digitales.",
        "cert17_name": "Storytelling en el Marketing Digital",
        "cert17_desc": "Técnicas de narrativa aplicadas al marketing digital para crear contenido memorable.",
        "cert18_name": "Fundamentos de ciberseguridad",
        "cert18_desc": "Conceptos esenciales de ciberseguridad para proteger información y sistemas digitales.",
    ...
    de: {
        ...
        "cert1_name": "SEO y content marketing",
        "cert1_desc": "Grundlagen von SEO und Content-Erstellung zur Positionierung von Marken und Gewinnung eines digitalen Publikums.",
        "cert2_name": "Marketing automation",
        "cert2_desc": "Automatisierung von Marketingprozessen zur Optimierung von Kampagnen und Kundenbeziehungen.",
        "cert3_name": "Introducción al comportamiento del consumidor",
        "cert3_desc": "Psychologische und marktbezogene Prinzipien, die die Kaufentscheidungen von Konsumenten erklären.",
        "cert4_name": "Introducción a la Ciencia de Datos",
        "cert4_desc": "Grundlegende Konzepte der Datenwissenschaft: Datenerfassung, -analyse und -visualisierung.",
        "cert5_name": "Google: IA Práctica para Marketing",
        "cert5_desc": "Praktische Anwendung generativer KI in Marketingstrategien.",
        "cert6_name": "Excel",
        "cert6_desc": "Fortgeschrittene Nutzung von Microsoft Excel zur Datenanalyse und -organisation.",
        "cert7_name": "English Fundamentals: Collaborating for Team Success",
        "cert7_desc": "Englischer Wortschatz und Kommunikationsfähigkeiten für effektive Teamarbeit.",
        "cert8_name": "Domina la IA con Gemini",
        "cert8_desc": "Praktischer Einsatz von Gemini als KI-Assistent im Alltag.",
        "cert9_name": "Desarrollo y Crecimiento Profesional",
        "cert9_desc": "Strategien zur Karriereplanung und Entwicklung beruflicher Fähigkeiten.",
        "cert10_name": "Elevating Your English: Communicating as a Leader",
        "cert10_desc": "Fortgeschrittenes Englisch mit Fokus auf Führungskommunikation im beruflichen Umfeld.",
        "cert11_name": "Del propósito a la acción: Generando impacto en sostenibilidad",
        "cert11_desc": "Werkzeuge zur Umsetzung von Nachhaltigkeitszielen in konkrete Maßnahmen.",
        "cert12_name": "AI and Responsibility: Creating a Positive AI",
        "cert12_desc": "Prinzipien der Ethik und verantwortungsvollen künstlichen Intelligenz nach IBM.",
        "cert13_name": "Power BI Intermedio: Análisis y modelado de datos",
        "cert13_desc": "Datenanalyse und -modellierung mit Power BI auf mittlerem Niveau.",
        "cert14_name": "Customer centricity y experiencia de cliente",
        "cert14_desc": "Kundenorientierte Strategie und digitale Transformation für Führungskräfte.",
        "cert15_name": "Gestión de Proyectos y Fundamentos de metodología Agile",
        "cert15_desc": "Grundlagen des Projektmanagements und agiler Methoden.",
        "cert16_name": "Product management: diseño y lanzamiento de productos digitales",
        "cert16_desc": "Prozess der Konzeption, Entwicklung und Markteinführung digitaler Produkte.",
        "cert17_name": "Storytelling en el Marketing Digital",
        "cert17_desc": "Narrative Techniken im digitalen Marketing zur Erstellung einprägsamer Inhalte.",
        "cert18_name": "Fundamentos de ciberseguridad",
        "cert18_desc": "Grundlegende Konzepte der Cybersicherheit zum Schutz von Informationen und digitalen Systemen.",
    ...
    en: {
        ...
        "cert1_name": "SEO y content marketing",
        "cert1_desc": "Fundamentals of SEO and content creation to position brands and attract digital audiences.",
        "cert2_name": "Marketing automation",
        "cert2_desc": "Marketing process automation to optimize campaigns and customer relationships.",
        "cert3_name": "Introducción al comportamiento del consumidor",
        "cert3_desc": "Psychological and market principles that explain consumers' purchasing decisions.",
        "cert4_name": "Introducción a la Ciencia de Datos",
        "cert4_desc": "Fundamental data science concepts: data collection, analysis, and visualization.",
        "cert5_name": "Google: IA Práctica para Marketing",
        "cert5_desc": "Practical application of generative AI in marketing strategies.",
        "cert6_name": "Excel",
        "cert6_desc": "Intermediate use of Microsoft Excel for data analysis and organization.",
        "cert7_name": "English Fundamentals: Collaborating for Team Success",
        "cert7_desc": "English vocabulary and communication skills for effective teamwork.",
        "cert8_name": "Domina la IA con Gemini",
        "cert8_desc": "Practical use of Gemini as an everyday AI assistant.",
        "cert9_name": "Desarrollo y Crecimiento Profesional",
        "cert9_desc": "Strategies for career planning and professional skills development.",
        "cert10_name": "Elevating Your English: Communicating as a Leader",
        "cert10_desc": "Advanced English focused on leadership communication in professional settings.",
        "cert11_name": "Del propósito a la acción: Generando impacto en sostenibilidad",
        "cert11_desc": "Tools to turn sustainability goals into concrete actions.",
        "cert12_name": "AI and Responsibility: Creating a Positive AI",
        "cert12_desc": "Principles of ethics and responsible artificial intelligence according to IBM.",
        "cert13_name": "Power BI Intermedio: Análisis y modelado de datos",
        "cert13_desc": "Intermediate-level data analysis and modeling with Power BI.",
        "cert14_name": "Customer centricity y experiencia de cliente",
        "cert14_desc": "Customer-centered strategy and digital transformation for leaders.",
        "cert15_name": "Gestión de Proyectos y Fundamentos de metodología Agile",
        "cert15_desc": "Fundamentals of project management and agile methodologies.",
        "cert16_name": "Product management: diseño y lanzamiento de productos digitales",
        "cert16_desc": "Process of designing, developing, and launching digital products.",
        "cert17_name": "Storytelling en el Marketing Digital",
        "cert17_desc": "Narrative techniques applied to digital marketing to create memorable content.",
        "cert18_name": "Fundamentos de ciberseguridad",
        "cert18_desc": "Essential cybersecurity concepts to protect information and digital systems.",
